			...
			<div class="container">
				...
				<div class="wpml-languages enabled">
					...
					<ul class="wpml-lang-dropdown">
						<li><a href="index-paywith-wing.php"><img src="images/en.png" alt="" width="18" height="12"></a></li>
					</ul>
				</div>
			...
			<div class="layout-1">
				<div class="container">
					...
					<div class="graphic-wrap animated hiding" data-animation="fadeInUp">
						<img class="lazyload" src="images/lazyload.png" data-src="images/img-april/paywithwing.png" alt="">
			...
			<div class="layout-4">
				<div class="container">
					<div class="column-3-wrap">
						<ul>
							<li>
								<figure><img src="images/img-april/paywithwing1.png" alt=""></figure>
								<p> បញ្ចុះតម្លៃពេលអ្នកទិញវ៉ែនតាពីហាង One Optical! រហូតដល់ថ្ងៃទី 31 ខែធ្នូ ឆ្នាំ 2018 តែប៉ុណ្ណោះ</p>
							</li>

							<li>
								<figure><img src="images/img-april/paywithwing2.png" alt=""></figure>
								<p>ណាត់ជួបនៅហាងកាហ្វេ Chamkar Cafe និងរីករាយជាមួយការបញ្ចុះតម្លៃ 30% តាមវីង។ រហូតដល់ថ្ងៃទី 31 ខែធ្នូ ឆ្នាំ 2018 តែប៉ុណ្ណោះ</p>
							</li>

							<li>
								<figure><img src="images/img-april/paywithwing3.png" alt=""></figure>
								<p>ផាត់មុខនិងធ្វើសក់នៅហាង Missing You Salon ព្រមទាំងរីករាយជាមួយការបញ្ចុះតម្លៃ 20%! រហូតដល់ថ្ងៃទី 31 ខែធ្នូ ឆ្នាំ 2018 តែប៉ុណ្ណោះ</p>
							</li>
						</ul>
