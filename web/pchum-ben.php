...
<section id="main-container">
    <section id="main-wrapper" class="promo-layout">
				...
				<div class="container">
					...
					<div class="wpml-languages enabled">
						...
						<ul class="wpml-lang-dropdown">
							<li><a href="khmer-pchum-ben"><img src="images/km.png" alt="" width="18" height="12"></a></li>
						</ul>
					</div>
					<div class="clr"></div>
				</div>
        ...
        <section class="main-wrapper">
            ...
            <div class="container">
                ...
                <div class="pl-row">
                    ...
                    <div class="box-wrap">
                        <h4>Terms and conditions to get this special offer:</h4>
                        <ul>
                            <li>Send money from Wing Account to Wing Account</li>
                            <li>Send money from Wing Account to Wing Wei Luy</li>
                            <li>Phone Top Up</li>
                            <li>Online Payment</li>
                            <li>Bills Payment</li>
                            <li>Pay with Wing</li>
                            <li>Utilities payment more than $25</li>
                        </ul>
                    </div>
                    <div class="clr"></div>
