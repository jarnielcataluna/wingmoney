			...
			<div class="container">
				...
				<div class="wpml-languages enabled">
					...
					<ul class="wpml-lang-dropdown">
						<li><a href="index-onlinepayment-km"><img src="images/km.png" alt="" width="18" height="12"></a></li>
					</ul>
				</div>
					...
					<div class="table-wrap">
						<div class="table-cell">
							<div class="banner-text text-center">
								<h1>
									<img src="images/wing-aug/first-image/online-pay.png" alt="">
								</h1>
								<p class="animated hiding" data-animation="fadeInUp" data-delay="300">Online shopping made better with just your smartphone and a Wing account! </p>
								<br>
								<br>
			...
			<div class="layout-1">
				<div class="container">
					<div class="text-content animated hiding" data-animation="fadeInUp">
						<h3>Love shopping online? Buy anything at anytime you want with your smartphone and Wing account.</h3>
						<!-- <h3><strong>PAY TINI</strong></h3> -->
						<p>A shopper's dream come true! </p>
					...
					<div class="graphic-wrap animated hiding" data-animation="fadeInUp">
						<img class="lazyload" src="images/lazyload.png" data-src="images/wing-aug/second-image/online-pay.png" alt="">
			...
			<div class="layout-4">
				<div class="container">
					<div class="column-3-wrap">
						<ul>
							<li>
								<figure><img src="images/img-april/payonline1.png" alt=""></figure>
								<p>No need to go through the hassle of travelling or waiting in long lines. Shop online in the comfort of your home.</p>
							</li>

							<li>
								<figure><img src="images/img-april/payonline2.png" alt=""></figure>
								<p>Secure and safe online shopping.</p>
							</li>

							<li>
								<figure><img src="images/img-april/payonline3.png" alt=""></figure>
								<p>Book your travels, shop for clothes or gadgets, and more with your phone and Wing. </p>
							</li>
						</ul>
