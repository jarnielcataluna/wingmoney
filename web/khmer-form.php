                        ...
                        <form class="wing-form" method="post" action="exec/validate.php" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="wing-checkbox terms-condi-wrap">
                                    ...
                                    <label for="terms-checkbox">ខ្ញុំយល់ព្រមចំពោះ <a href="https://www.wingmoney.com/km/about-wing/terms-and-conditions/" target="_blank" style="color: #00adef;">លក្ខខណ្ឌផ្សេងៗដែលបានចែង!</a></label>
                                </div>
