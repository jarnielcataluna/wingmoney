			...
			<div class="container">
				...
				<div class="wpml-languages enabled">
					...
					<ul class="wpml-lang-dropdown">
						<li><a href="index-sendmoney.php"><img src="images/en.png" alt="" width="18" height="12"></a></li>
					</ul>
				</div>
					...
					<div class="table-wrap">
						<div class="table-cell">
							<div class="banner-text text-center">
								...
								<p class="animated hiding" data-animation="fadeInUp" data-delay="300">វេរលុយភ្លាមៗគ្រប់ពេលវេលា គ្រប់ទីកន្លែងតាមទូរស័ព្ទដៃរបស់អ្នកក្នុងតម្លៃតែ 400៛ ប៉ុណ្ណោះ!  </p>
								<br>
								<br>
			...
			<div class="layout-1">
				<div class="container">
					<div class="text-content animated hiding" data-animation="fadeInUp">
						<h3>វីងផ្តល់ជូននូវជម្រើសមានភាពបត់បែនពេលអ្នកវេរលុយពីទូរស័ព្ទដៃទៅកាន់មនុស្សជាទីស្រលាញ់គ្រប់ទីកន្លែងទូទាំងប្រទេសកម្ពុជា!</h3>
						<!-- <h3><strong>TRANSFER MONEY TINI</strong></h3> -->
						<p>អ្វីដែលអ្នកត្រូវការគឺគណនីវីងនិងកម្មវិធីស្មាតហ្វូនវីងប៉ុណ្ណោះ! </p>
						<a href="form.php<?php echo $source.$medium.$campaign; ?>" class="btn click-apply">បើកគណនីវីងរបស់អ្នកឥឡូវនេះ!</a>
						<p><a href="#layout-2" class="btn-knowmore">ធ្វើបានគ្រប់យ៉ាង ទីនេះ!</a></p>
					</div>
					<div class="graphic-wrap animated hiding" data-animation="fadeInUp">
						<img class="lazyload" src="images/lazyload.png" data-src="images/img-april/sendmoney.png" alt="">
					...
					<div class="column-3-wrap">
						<ul>
							<li>
								...
								<p>*វេរលុយទៅមនុស្សជាទីស្រលាញ់ភ្លាមៗដោយគ្រាន់តែចុចប៊ូតុង!</p>
							</li>

							<li>
								<figure><img src="images/img-april/sendmoney-2.png" alt=""></figure>
								<p>*មិនចាំបាច់ទៅធនាគារឬកន្លែងវេរលុយនិងធ្វើការបំពេញបែបបទឡើយ។</p>
							</li>

							<li>
								<figure><img src="images/img-april/sendmoney-3.png" alt=""></figure>
								<p>*វេរលុយយ៉ាងងាយស្រួលទៅកាន់មនុស្សគ្រប់គ្នាដោយគ្រាន់តែឲ្យពួកគាត់ទៅដកប្រាក់នៅតាមភ្នាក់ងារវីងណាមួយទាំង 5,000 កន្លែងទូទាំងប្រទេស ឬផ្ទេរប្រាក់ទៅប្រទេសក្រៅច្រើនជាង 50 ប្រទេសតាមដៃគូសហការផ្ទេរប្រាក់ក្រៅប្រទេសរបស់វីង។ </p>
							</li>
						</ul>
