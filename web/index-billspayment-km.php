			...
			<div class="container">
				...
				<div class="wpml-languages enabled">
					...
					<ul class="wpml-lang-dropdown">
						<li><a href="index-billspayment.php"><img src="images/en.png" alt="" width="18" height="12"></a></li>
					</ul>
				</div>
					...
					<div class="table-wrap">
						<div class="table-cell">
							<div class="banner-text text-center">
								<h1>
									<img src="images/wing-sept/first-image/bills.png" alt="">
								</h1>
								<p class="animated hiding" data-animation="fadeInUp" data-delay="300">វីងធានាផ្តល់ជូនភាពងាយស្រួល និងសុវត្ថិភាព។ បង់វិក្កយបត្ររបស់អ្នកតាមវីង! </p>
								<br>
								<br>
			...
			<div class="layout-1">
				<div class="container">
					<div class="text-content animated hiding" data-animation="fadeInUp">
						<h3>ហេតុអ្វីបានជាត្រូវតក់ក្រហល់ក្នុងការបង់វិក្កយបត្ររបស់អ្នក? ជាមួយវីង អ្នកលែងបារម្ភទៀតហើយ!</h3>
						<!-- <h3><strong>PAY TINI</strong></h3> -->
						<p>វីងជួយអ្នកក្នុងការបង់វិក្កយបត្របានដោយងាយស្រួល រហ័ស និងមានសុវត្ថិភាព!</p>
					...
					<div class="graphic-wrap animated hiding" data-animation="fadeInUp">
						<img class="lazyload" src="images/lazyload.png" data-src="images/wing-sept/second-image/Bills.png" alt="">
			...
			<div class="layout-4">
				<div class="container">
					<div class="column-3-wrap">
						<ul>
							<li>
								<figure><img src="images/img-april/billpayment1.png" alt=""></figure>
								<p>ទូទាត់វិក្កយបត្រទឹកភ្លើងក្រោម $25 ដោយឥតគិតថ្លៃ!</p>
							</li>

							<li>
								<figure><img src="images/img-april/billpayment2.png" alt=""></figure>
								<p>ទូទាត់ទឹកភ្លើង កម្ចី ទៅកាន់អ្នកផ្គត់ផ្គង់ និងច្រើនទៀតតាមដៃគូបង់វិក្កយបត្រច្រើនជាង 80 ក្រុមហ៊ុន និងមីក្រូហិរញ្ញវត្ថុ 50 បានភ្លាមៗ។</p>
							</li>

							<li>
								<figure><img src="images/img-april/billpayment3.png" alt=""></figure>
								<p>បទពិសោធន៍ទូទាត់វិក្កយបត្រដែលងាយស្រួលបំផុតមិនធ្លាប់មាន។ </p>
							</li>
						</ul>
