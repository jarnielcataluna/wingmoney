					...
					<div class="table-wrap">
						<div class="table-cell">
							<div class="banner-text text-center">
								...
								<p class="animated hiding" data-animation="fadeInUp" data-delay="300">ទទួលយកការទិញទំនិញដែលងាយស្រួលដោយរីករាយក្នុងប្រទេសកម្ពុជា ដោយគ្រាន់តែប្រើទូរស័ព្ទដៃនិងគណនីវីង!</p>
								<br>
								<br>
			...
			<div class="layout-1">
				<div class="container">
					<div class="text-content animated hiding" data-animation="fadeInUp">
						<h3>ចូលចិត្តទិញទំនិញអនឡាញមែនទេ? ទិញអ្វីក៏បានគ្រប់ពេលវេលាដោយប្រើទូរស័ព្ទស្មាតហ្វូននិងគណនីវីងរបស់អ្នក។</h3>
						<!-- <h3><strong>PAY TINI</strong></h3> -->
						<p>ករាយជាមួយការទិញទំនិញ ទីនេះ!</p>
