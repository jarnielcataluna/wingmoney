					...
					<div class="table-wrap">
						<div class="table-cell">
							<div class="banner-text text-center">
								...
								<p class="animated hiding" data-animation="fadeInUp" data-delay="300">ការទិញទំនិញអនឡាញរបស់អ្នកកាន់តែងាយស្រួលជាមួយទូរស័ព្ទដៃ និងគណនីវីងរបស់អ្នក!</p>
								<br>
								<br>
					...
					<div class="column-3-wrap">
						<ul>
							<li>
								...
								<p>មិនចាំបាច់ធ្វើដំណើរឬឈរតម្រង់ជួរទៀតឡើយ។ ទិញទំនិញអនឡាញពីផ្ទះរបស់អ្នកតែម្តង។</p>
							</li>

							<li>
								<figure><img src="images/img-april/payonline2.png" alt=""></figure>
								<p>ទិញទំនិញអនឡាញមានសុវត្ថិភាព។ </p>
							</li>

							<li>
								<figure><img src="images/img-april/payonline3.png" alt=""></figure>
								<p>កក់ការធ្វើដំណើររបស់អ្នក ទិញខោអាវ ឬ ឧបករណ៍អេឡិចត្រូនិច និងច្រើនទៀតតាមទូរស័ព្ទដៃនិងគណនីវីង។</p>
							</li>
						</ul>
