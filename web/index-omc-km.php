			...
			<div class="container">
				...
				<div class="wpml-languages enabled">
					...
					<ul class="wpml-lang-dropdown">
						<li><a href="index-omc.php"><img src="images/en.png" alt="" width="18" height="12"></a></li>
					</ul>
				</div>
					...
					<div class="column-3-wrap">
						<ul>
							<li>
								...
								<p>ជាម៉ាស្ទ័រកាតអនឡាញដែលបើកដោយខ្លួនអ្នកផ្ទាល់។ ទទួលស្គាល់ទូទាំងពិភពលោក។</p>
							</li>

							<li>
								<figure><img src="images/img-april/omc2.png" alt=""></figure>
								<p>រហ័ស ងាយស្រួល និងសុវត្ថិភាព។</p>
							</li>

							<li>
								<figure><img src="images/img-april/omc3.png" alt=""></figure>
								<p>មានគណនីវីងមែនទេ? បើកបានភ្លាមៗ មិនចាំបាច់រង់ចាំនោះទេ។</p>
							</li>
						</ul>
