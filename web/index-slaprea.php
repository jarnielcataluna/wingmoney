			...
			<div class="container">
				...
				<div class="wpml-languages enabled">
					...
					<ul class="wpml-lang-dropdown">
						<li><a href="index-slaprea-km.php"><img src="images/km.png" alt="" width="18" height="12"></a></li>
					</ul>
				</div>
				...
				<div class="table-wrap">
					<div class="table-cell">
						<figure class="new-banner animated hiding" data-animation="fadeInUp" data-delay="200">
							...
							<picture>
								<source media="(min-width: 768px)" srcset="images/slaprea/banner.jpg">
								<source media="(min-width: 320px)" srcset="images/slaprea/banner-mobile.jpg">
					...
					<div class="column-3-wrap">
						<ul>
							<li>
								...
								<p>Enjoy FREE access to competitions and activities.</p>
							</li>

							<li>
								<figure><img src="images/slaprea/icon2.png" alt=""></figure>
								<p>Get to Slaprea without hassle via PassApp, Tuktuk, and Taxi Phumi.</p>
							</li>

							<li>
								<figure><img src="images/slaprea/icon3.png" alt=""></figure>
								<p>Get a chance to win amazing prizes.</p>
							</li>
						</ul>
