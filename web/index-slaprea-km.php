			...
			<div class="container">
				...
				<div class="wpml-languages enabled">
					...
					<ul class="wpml-lang-dropdown">
						<li><a href="index-slaprea.php"><img src="images/en.png" alt="" width="18" height="12"></a></li>
					</ul>
				</div>
			...
			<div class="banner-wrap">
				<div class="table-wrap">
					<div class="table-cell">
						<figure class="new-banner animated hiding" data-animation="fadeInUp" data-delay="200">
						
							<picture>
								<source media="(min-width: 768px)" srcset="images/slaprea/banner-khmer.jpg">
								<source media="(min-width: 320px)" srcset="images/slaprea/banner-mobile-khmer.jpg">
			...
			<div class="layout-4">
				<div class="container">
					<div class="column-3-wrap">
						<ul>
							<li>
								<figure><img src="images/slaprea/icon1.png" alt=""></figure>
								<p>ចូលរួមការប្រកួត និងកម្មវិធីឥតគិតថ្លៃ។</p>
							</li>

							<li>
								<figure><img src="images/slaprea/icon2.png" alt=""></figure>
								<p>ធ្វើដំណើរទៅពិព័រណ៍អាហារស្លាបព្រាតាម PassApp កង់បី និងឡាន Taxi Phumi យ៉ាងងាយស្រួល។</p>
							</li>

							<li>
								<figure><img src="images/slaprea/icon3.png" alt=""></figure>
								<p>មានឱកាសឈ្នះរង្វាន់ជាច្រើន។</p>
							</li>
						</ul>
