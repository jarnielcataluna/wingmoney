			...
			<div class="container">
				...
				<div class="wpml-languages enabled">
					...
					<ul class="wpml-lang-dropdown">
						<li><a href="index-paywith-wing-km.php"><img src="images/km.png" alt="" width="18" height="12"></a></li>
					</ul>
				</div>
					...
					<div class="column-3-wrap">
						<ul>
							<li>
								...
								<p>Score 20% discount when you buy your new specs at One Optical! until 31 Dec 18 only</p>
							</li>

							<li>
								<figure><img src="images/img-april/paywithwing2.png" alt=""></figure>
								<p>Book your next date at the Chamkar Cafe and enjoy 30% discount with Wing. until 31 Dec 18 only</p>
							</li>

							<li>
								<figure><img src="images/img-april/paywithwing3.png" alt=""></figure>
								<p>Get your latest makeover at the Missing You Salon with 20% discount! until 31 Dec 18 only </p>
							</li>
						</ul>
