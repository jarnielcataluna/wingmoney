			...
			<div class="container">
				...
				<div class="wpml-languages enabled">
					...
					<ul class="wpml-lang-dropdown">
						<li><a href="index-omc-km.php"><img src="images/km.png" alt="" width="18" height="12"></a></li>
					</ul>
				</div>
					...
					<div class="table-wrap">
						<div class="table-cell">
							<div class="banner-text text-center">
								<h1>
									<img src="images/wing-aug/first-image/OMC.png" alt="">
								</h1>
			...
			<div class="layout-1">
				<div class="container">
					...
					<div class="graphic-wrap animated hiding" data-animation="fadeInUp">
						<img class="lazyload" src="images/lazyload.png" data-src="images/wing-aug/second-image/OMC.png" alt="">
			...
			<div class="layout-4">
				<div class="container">
					<div class="column-3-wrap">
						<ul>
							<li>
								<figure><img src="images/img-april/omc1.png" alt=""></figure>
								<p>An instant self-issuance Online Mastercard. Accepted worldwide.</p>
							</li>

							<li>
								<figure><img src="images/img-april/omc2.png" alt=""></figure>
								<p>It's fast, secure, and very convenient. </p>
							</li>

							<li>
								<figure><img src="images/img-april/omc3.png" alt=""></figure>
								<p>Got Wing account? Get it fast. No waiting time required.</p>
							</li>
						</ul>
