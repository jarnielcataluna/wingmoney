			...
			<div class="container">
				...
				<div class="wpml-languages enabled">
					...
					<ul class="wpml-lang-dropdown">
						<li><a href="index-billspayment-km.php"><img src="images/km.png" alt="" width="18" height="12"></a></li>
					</ul>
				</div>
					...
					<div class="table-wrap">
						<div class="table-cell">
							<div class="banner-text text-center">
								...
								<p class="animated hiding" data-animation="fadeInUp" data-delay="300">Your convenience and security, guaranteed with Wing. Pay your bills with Wing! </p>
								<br>
								<br>
			...
			<div class="layout-1">
				<div class="container">
					<div class="text-content animated hiding" data-animation="fadeInUp">
						<h3>Why go through all the hassle of paying your bills? With Wing, you don't have to!</h3>
						<!-- <h3><strong>PAY TINI</strong></h3> -->
						<p>Wing lets you do it fast, secure and super easy!</p>
					...
					<div class="column-3-wrap">
						<ul>
							<li>
								...
								<p>FREE utility payment for bills under $25!</p>
							</li>

							<li>
								<figure><img src="images/img-april/billpayment2.png" alt=""></figure>
								<p>Pay your utilities, loans, suppliers, and more with over 80 billers and 50 MFIs in an instant.</p>
							</li>

							<li>
								<figure><img src="images/img-april/billpayment3.png" alt=""></figure>
								<p>Experience a stress-free bills payment now.</p>
							</li>
						</ul>
