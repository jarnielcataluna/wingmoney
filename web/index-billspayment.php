					...
					<div class="table-wrap">
						<div class="table-cell">
							<div class="banner-text text-center">
								...
								<p class="animated hiding" data-animation="fadeInUp" data-delay="300">TINI Enjoy the convenience And security of paying bills with Wing </p>
								<br>
								<br>
				...
				<div class="container">
					<div class="column-3-wrap">
						...
						<div class="text-center" style="padding-top: 30px;">
							<a href="form.php" class="btn click-apply">GET YOUR WING ACCOUNT NOW!</a>
						</div>
					</div>
				</div>
			</div>
