				...
				<div class="table-content">
					<div class="container">
						...
						<div class="wing-form-wrap animated hiding" data-animation="fadeInUp" data-delay="300">
								...
								<div class="signup-fb">
									<a href="#"><i class="fa fa-facebook" aria-hidden="true"></i><span>Sign-up with Facebook</span></a>
								</div>
								<form method="post" action="">
									<p class="form-text">Or fill up this form</p>
									<div class="form-row">
										<div class="input-wrap">
											<input type="text" id="last-name" name="" value="" required="required"></input>
											<label for="last-name">Last Name</label>
										</div>
										<div class="input-wrap">
											<input type="text" id="first-name" name="" value="" required="required"></input>
											<label for="first-name">First Name</label>
										</div>
										<div class="input-wrap input-half">
											<input type="text" id="birthday" name="" value="" required="required"></input>
										...
										<div class="clr"></div>
										<div class="input-wrap">
											<input type="text" id="contact-num" name="" value="" required="required"></input>
											<label for="contact-num">Contact Number</label>
										</div>
										<div class="input-wrap">
											<input type="email" id="email" name="" value="" required="required"></input>
											<label for="email">Email</label>
										</div>
										<div class="input-wrap input-half">
											<select class="custom-select">
												<option>Sample adasd</option>
												<option>Sample dsadsadasdasd</option>
												<option>Sample</option>
												<option>Sample</option>
											</select>
										</div>
										<div class="input-wrap input-half">
											<input type="email" id="id-number" name="" value="" required="required"></input>
											<label for="id-number">ID Number</label>
										</div>
										<div class="input-wrap choose-currency">
											<label>Choose Currency:</label>
											<div class="custom-radio">
												<input type="radio" id="usd" name="radio" />
												<label for="usd"><span></span>USD</label>
											</div>	
											<div class="custom-radio">
												<input type="radio" id="Khmer" name="radio" />
												<label for="Khmer"><span></span>Khmer</label>
											</div>					
										</div>
										<div class="input-wrap select-branch">
											<select class="custom-select">
												<option>Sampleasdsa asdsa dsad</option>
												<option>Sample</option>
												<option>Sampleasdas asd asdsad</option>
												<option>Sample adasd</option>
											</select>
										</div>
										<hr>
						...
						<li class="animated hiding" data-animation="fadeInUp">
							<div class="wing-benifits-wrap">
								<div class="wing-benifits-img">
									<img src="images/icon-placeholder.jpg" alt="">
								</div>
