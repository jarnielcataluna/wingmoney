				...
				<div class="table-content">
					<div class="container">
						...
						<div class="wing-form-wrap animated hiding" data-animation="fadeInUp" data-delay="300">
								...
								<form class="wing-form" method="post" action="form.html" novalidate>
									<p class="form-text">Or fill up this form</p>
									<div class="form-row">
										<div class="input-wrap">
											<input type="text" id="last-name" name="" value="" required="required">
										...
										<div class="input-wrap input-half">
											<input type="text" id="birthday" name="" value="" required="required">
										...
										<div class="clr"></div>
										<div class="input-wrap">
											<input type="text" id="contact-num" name="" value="" required="required">
										...
										<div class="input-wrap">
											<input type="email" id="account-email" name="" value="" required="required" onkeyup="this.setAttribute('value', this.value);">
										...
										<div class="input-wrap input-half id-type">
											<select class="custom-select">
												...
												<option value="1">Sample dsadsadasdasd</option>
										...
										<div class="input-wrap input-half">
											<input type="text" id="id-number" name="" value="" required="required">
										...
										<div class="input-wrap choose-currency">
											...
											<div class="custom-radio">
												<input type="radio" id="usd" name="radio" checked>
